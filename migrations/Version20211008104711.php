 ...
 */
final class Version20211008104711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE home_slider (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, button_message VARCHAR(255) NOT NULL, button_url VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, is_display BOOLEAN DEFAULT NULL)');
        $this->addSql('DROP INDEX IDX_D4E6F81A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__address AS SELECT id, user_id, fullname, campany, address, complement, phone, city, code_postal, country FROM address');
        $this->addSql('DROP TABLE address');
        $this->addSql('CREATE TABLE address (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, fullname VARCHAR(255) NOT NULL COLLATE BINARY, campany VARCHAR(255) DEFAULT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, complement VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone INTEGER NOT NULL, city VARCHAR(255) NOT NULL COLLATE BINARY, code_postal INTEGER NOT NULL, country VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_D4E6F81A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO address (id, user_id, fullname, campany, address, complement, phone, city, code_postal, country) SELECT id, user_id, fullname, campany, address, complement, phone, city, code_postal, country FROM __temp__address');
        $this->addSql('DROP TABLE __temp__address');
        $this->addSql('CREATE INDEX IDX_D4E6F81A76ED395 ON address (user_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__carrier AS SELECT id, name, description, price, created_at, update_at FROM carrier');
        $this->addSql('DROP TABLE carrier');
        $this->addSql('CREATE TABLE carrier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , update_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        )');
        $this->addSql('INSERT INTO carrier (id, name, description, price, created_at, update_at) SELECT id, name, description, price, created_at, update_at FROM __temp__carrier');
        $this->addSql('DROP TABLE __temp__carrier');
        $this->addSql('DROP INDEX IDX_F5299398A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, user_id, reference, full_name, carrier_name, carrier_price, delivery_address, is_paid, more_informations, create_at FROM "order"');
        $this->addSql('DROP TABLE "order"');
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, reference VARCHAR(255) NOT NULL COLLATE BINARY, full_name VARCHAR(255) NOT NULL COLLATE BINARY, carrier_name VARCHAR(255) NOT NULL COLLATE BINARY, carrier_price DOUBLE PRECISION NOT NULL, delivery_address CLOB NOT NULL COLLATE BINARY, is_paid BOOLEAN NOT NULL, more_informations CLOB DEFAULT NULL COLLATE BINARY, create_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , CONSTRAINT FK_F5299398A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO "order" (id, user_id, reference, full_name, carrier_name, carrier_price, delivery_address, is_paid, more_informations, create_at) SELECT id, user_id, reference, full_name, carrier_name, carrier_price, delivery_address, is_paid, more_informations, create_at FROM __temp__order');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__address AS SELECT id, user_id, fullname, campany, address, complement, phone, city, code_postal, country FROM address');
        $this->addSql('DROP TABLE address');
        $this->addSql('CREATE TABLE address (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, fullname VARCHAR(255) NOT NULL, campany VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, complement VARCHAR(255) DEFAULT NULL, phone INTEGER NOT NULL, city VARCHAR(255) NOT NULL, code_postal INTEGER NOT NULL, country VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO address (id, user_id, fullname, campany, address, complement, phone, city, code_postal, country) SELECT id, user_id, fullname, campany, address, complement, phone, city, code_postal, country FROM __temp__address');
        $this->addSql('DROP TABLE __temp__address');
        $this->addSql('CREATE INDEX IDX_D4E6F81A76ED395 ON address (user_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__carrier AS SELECT id, name, description, price, created_at, update_at FROM carrier');
        ...
        , update_at DATETIME DEFAULT \'NULL --(DC2Type:datetime_immutable)\' --(DC2Type:datetime_immutable)
        )');
        $this->addSql('INSERT INTO carrier (id, name, description, price, created_at, update_at) SELECT id, name, description, price, created_at, update_at FROM __temp__carrier');
        $this->addSql('DROP TABLE __temp__carrier');
        $this->addSql('DROP INDEX IDX_F5299398A76ED395');
