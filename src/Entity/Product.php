...
class Product
{
     ...
     */
    private $isBestSeller = false; //valeur par defaut

    /**
     * @ORM\Column(type="boolean", nullable=true)
     */
    private $isNewArrival = false; //valeur par defaut;

    /**
     * @ORM\Column(type="boolean", nullable=true)
     */
    private $isFeatured = false; //valeur par defaut;

    /**
     * @ORM\Column(type="boolean", nullable=true)
     */
    private $isSpecialOffer = false; //valeur par defaut;
    ...
    //pour recuperer les produits en string objet
